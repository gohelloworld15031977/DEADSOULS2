#!/usr/bin/env python3
"""
Продолжение обучения до 5 эпох с сохранением результатов
"""
...
def main():
    print("=== Продолжение обучения до 5 эпох ===")
    
    # Настройки
    MODEL_NAME = "ai-forever/rugpt3small_based_on_gpt2"
    DATA_PATH = "data/tokenized_gpt2"
    CHECKPOINT_PATH = "./gogol_finetuned_final/checkpoint-1125"  # Эпоха 3.0
    OUTPUT_DIR = "./gogol_finetuned_to_5epochs"
    TARGET_EPOCHS = 5
    ...
    print(f"Текущая эпоха: 3.0")
    print(f"Целевая эпоха: {TARGET_EPOCHS}")
    print(f"Дополнительные эпохи: {TARGET_EPOCHS - 3}")
