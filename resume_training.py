#!/usr/bin/env python3
# Скрипт для продолжения обучения с checkpoint
import torch
import os
...
def main():
    ...
    # LoRA конфигурация (должна совпадать с оригинальной)
    ...
    training_args = TrainingArguments(
        ...
        save_total_limit=3,
        resume_from_checkpoint=CHECKPOINT_PATH  # ключевой параметр для продолжения
    )
